 ...
 *
 */
public class SampleScoringBoardActivity extends Activity implements DialogReturnable {

	private static final String TAG = SampleScoringBoardActivity.class.getSimpleName();

	private Loggable _log = new AndroidLog();
	private SamplePlayBoard _game = null;
	protected static SampleScoringBoardActivity _myActiv = null;
...
*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _game = new SamplePlayBoard(this.getLog());
